            ...
            <div class="container"><a href="index.php" class="navbar-brand text-uppercase font-weight-bold">PING ESIGELEC</a>
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="home_conn_resp.php" aria-current="page" class="nav-link text-uppercase font-weight-bold">Revenir aux sujets</a></li>
                    </ul>
                </div>
                <?php session_start();
