...
<div style="display:flex;margin-left: 32%;margin-top: 5%;">
 <div class="card" style="width: 18rem;margin-right:15px;">
  <img class="card-img-top" src="images/add_user.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title" style="margin-left: 10px;">Contrôle des inscriptions</h5>
    <a href="control_tutor.php" class="btn btn-primary" style="margin-left:95px">Gérer</a>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/book.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title" style="margin-left: 25px;">Contrôle des sujets</h5>
    <a href="home_conn_resp.php" class="btn btn-primary" style="margin-left:95px">Gérer</a>
  </div>
</div>
</div>