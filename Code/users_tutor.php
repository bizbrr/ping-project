...
<div class="tab">
        <div class="d-flex justify-content-center row">
            ...
            <?php } } ?>
                    <h3 style="color:white; text-align:center; font-family: 'Poppins',sans-serif; margin-bottom:20px;">Liste des resposables</h3>
                    <a  href="users_resp.php" class="btn btn-primary" style="margin-bottom:10px;">Gérer les comptes responsable</a>
                        ...
                        <table class="table">
                            ...
                            <?php while($data = mysqli_fetch_array($resultat)) { 
                                ...
                                <tr class="cell-1 bg-tab">
                                    ...
                                    <td>
                                        <a  href="delete_tutor.php?id=<?php echo $data['id_tutor']; ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                                    </td>
